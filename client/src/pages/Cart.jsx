  ...
  if (cart.length === 0) {
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center bg-[#0a0a0a]">
        ...
        <Link 
          to="/products" 
          className="text-[#ff6b35] font-mono text-sm uppercase tracking-wider border border-[#ff6b35] px-6 py-3 hover:bg-[#ff6b35] hover:text-black transition-all duration-300"
        >
