      ...
      {!isAuthenticated ? (
        <div className="flex items-center justify-center min-h-[80vh]">
          ...
          >
            ...
            <h1 className="text-2xl font-black text-white mb-2">Login to view your wishlist</h1>
            <Link to="/login" className="text-[#ff6b35] font-mono text-sm uppercase tracking-wider hover:underline">Sign in</Link>
          </motion.div>
        </div>
      ) : loading ? (
        <div className="flex items-center justify-center min-h-[80vh]">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                {wishlist.products.map((product, index) => (
                  <motion.div
                    ...
                    className="border border-gray-800 bg-[#0f0f0f] group"
                  >
