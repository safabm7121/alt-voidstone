  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-12 bg-[#0a0a0a] relative overflow-hidden">
      ...
      >
        ...
        >
          {/* Subtle white spotlight - half opacity */}
          <div 
          ...
          <div className="relative z-10">
            <div className="text-center mb-8">
              <h1 className="text-3xl font-black uppercase tracking-tighter text-white mb-2">{t('auth.login')}</h1>
              <p className="text-gray-500 font-mono text-xs">Welcome back to Voidstone Studio</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="text-right">
                <Link to="/forgot-password" className="text-xs text-[#ff6b35] hover:text-[#ff8555] transition font-mono uppercase tracking-wider">
            ...
            <p className="text-center text-gray-500 text-sm mt-6 font-mono">
              {t('auth.noAccount')}{' '}
              <Link to="/register" className="text-[#ff6b35] hover:text-[#ff8555] transition">{t('auth.register')}</Link>
            </p>
          </div>
        </div>
      </motion.div>
